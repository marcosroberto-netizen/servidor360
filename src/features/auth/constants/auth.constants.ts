export const PERMISSIONS = {
  ...
  AFASTAMENTOS_GERAR_DOCUMENTO: 'afastamentos:gerar_documento',
  AFASTAMENTOS_ASSINAR_DOCUMENTO: 'afastamentos:assinar_documento',
  AFASTAMENTOS_VALIDAR_DOCUMENTO: 'afastamentos:validar_documento',
